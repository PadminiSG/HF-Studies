...
use hfref_dpp4glp1_priorhfhospi.dta
gen dof= dofc(dpp4filltime)
gen admin= dofc(AdmitDateTime)
gen HFH = 1 
keep scrssn dof admin HFH
duplicates drop scrssn, force 
save "P:\ORD_Sundaram_202108013D\Padmini\Diabetes Stata Files\GLP1 new files hf\dpp4\diabetes_hfref_dpp4glp1_HFH_12_months.dta", replace 
*** 168 patients 
...
**** 168 patients with prior HFH
save "P:\ORD_Sundaram_202108013D\Padmini\Diabetes Stata Files\GLP1 new files hf\dpp4\diabetes_hfref_dpp4glp1_prior_HFH.dta", replace 
**** Mean HFH 1.28, Median 1 (1-2)
