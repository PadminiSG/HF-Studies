...
gen outcome = min(admission_mi, admission_af, admission_hf, dod, follow_up)
gen no_outcome = 0 if admission_hf==. & admission_mi==. & admission_af==.
gen failure =0 if no_outcome ==. & dod==.
